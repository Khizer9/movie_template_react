...
const TvShowCard = ({searchQuery}) => {
  ...
  return (
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4" style={{padding: '20px 70px'}}>
    {loading ? filtershow.map((res) => (
<article
class="relative overflow-hidden rounded-lg shadow transition hover:shadow-lg">
<img
alt="Office"
src={res.image_thumbnail_path}
